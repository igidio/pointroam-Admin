<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-m">
    <div class="modal-content">
      ...
      <form action="{{ action('personalController@nuevo')}}" method="post" autocomplete="off">
      {{ csrf_field() }}                  
      ...
      <div class="row">
        ...
        <label class="control-label mb-1" for="ci">CI <span class="required">*</span></label>
          <input oninput="validarCaracteres('ci', 9)" onkeypress="return soloNumeros(event)" type="text" id="ci" name="ci" required="required" class="form-control" autocomplete="off" onkeyup="validar()">
        </div>
        <div class="col-3">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <div class="col-12">
              <input onchange="validar()" id="fnac" name="fnac" class="date-picker form-control" required="required" type="text" readonly style="background-color: #fff;">
      ...
      <div class="row">
        <div class="col-12">
        <label class="control-label mb-1" for="id_cargo">Cargo <span class="required">*</span></label>
          <?php $cargos = DB::table('cargos')->get() ?>
          <select class="form-control" id="id_cargo" name="id_cargo" required="required">
